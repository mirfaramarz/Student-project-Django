...
def project(request):
    ...
    '''
    Ajax is a technique used in web development to allow web pages to send and receive data from a server 
    asynchronously (in the background) without interfering with the display and behavior of 
    the existing page. 
    This enables web applications to update parts of a web page without reloading the 
    entire page.
    '''
    ...
    if request.is_ajax() and request.method == 'GET':
        #removing an object
        if request.GET.get('form_name') == 'delete_card':
    ...
    return render(request, 'milestone/project.html', {'project_form':project_form, 'project_list': projects})
...
def students(request):
    ...
    return render(request, 'milestone/students.html', {'student_form': student_form,
...
def testing(request):
    ...
    return render(request, 'milestone/test.html', context=data_test)